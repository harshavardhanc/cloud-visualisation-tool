...
export default function ImprovedOnboarding() {
  ...
  const handleConnectAccount = async () => {
    ...
    try {
      ...
      const provider = cloudProviders.find((p) => p.id === selectedProvider);
      const accountName =
        accountForm.name?.trim() || `${provider?.name} Account`;
        ...
        {currentStep === 3 && (
          <div className="max-w-2xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                Please wait while we establish a secure connection and discover
                your resources
              </p>
            </div>
        ...
        {currentStep === 4 && (
          <div className="max-w-2xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                Your {selectedProviderData?.name} account has been connected
                successfully. We've discovered your resources and you're ready
                to explore your infrastructure.
              </p>
            </div>
