              ...
              >
                ...
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Connect a new cloud account to monitor your
                      infrastructure.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        id="credentials"
                        type="password"
                        placeholder="Access key or subscription ID"
                      />
                    </div>
                  </div>
                  <DialogFooter>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredAccounts.map((account) => {
            const provider =
              providerInfo[account.provider as keyof typeof providerInfo];
            const status =
              statusInfo[account.status as keyof typeof statusInfo];
